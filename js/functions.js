...
$(function () {
	...
	$("#content").css("width", $loveHeart.width() + $("#message").width());
	$("#content").css("height", Math.max($loveHeart.height(), $("#message").height()));
...
function adjustMessagePosition() {
	$("#message").css("margin-top", ($("#garden").height() - $("#message").height()) / 2)
}
